...
from util.detector_utils import load_image  # noqa: E402
...
IMAGE_PATH = 'mmfashion_retrieval/06_1_front.jpg'
...
parser.add_argument(
    '--gallery',
    default='mmfashion_retrieval/gallery', type=str,
...
def recognize_from_video(filename, net):
    ...
    if args.savepath != SAVE_IMAGE_PATH:
        ...
        writer = util.webcamera_utils.get_writer(args.savepath, f_h, f_w)
    else:
        writer = None
